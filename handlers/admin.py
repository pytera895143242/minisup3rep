...
import sqlite3
from .sqlit import info_members, reg_one_channel, reg_channels,del_one_channel,cheak_traf,obnovatrafika,reg_partners_schet,cheach_all_par,info,reg_utm_support,cheak_support,changee_support,regviplata,cheak_viplats,change_infopay, changee_support_tochka
